...
- `index.html` is the whole site. Self-contained: no external scripts, no build step.
...
Generated 2026-09-20 by `build.py` in the NRD sites kit. Edit `index.html` directly or regenerate from the kit; either is fine, but do not do both without merging.
